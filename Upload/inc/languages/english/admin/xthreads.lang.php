...
$l['threadfields_hideedit_desc'] = 'If yes, will not display the input field on newthread/editpost pages through the <code>{$extra_threadfields}</code> variable.  This is useful if you want to place it in a different location.  You can access the HTML for this field by using <code>{$tfinputrow[\'<em>key</em>\']}</code>, which includes all the table markup (see <em>threadfields_inputrow</em> template).  Or, you can use <code>{$tfinput[\'<em>key</em>\']}</code> which gives the input field HTML without table markup (it\'s equivalent to the <code>{$inputfield}</code> variable in the <em>threadfields_inputrow</em> template).';
...
Like the <em>Input Formatter</em> option, this is not evaluated when editing a thread and the user has sent no value.';
...
$l['threadfields_formhtml_desc_attach_id'] = 'If there\'s an attachment, contains its ID';
$l['threadfields_formhtml_desc_attach_md5'] = 'If there\'s an attachment, contains its MD5 hash';
...
$l['threadfields_formhtml_desc_attach_url'] = 'If there\'s an attachment, contains its URL';
$l['threadfields_formhtml_desc_attach_filename'] = 'If there\'s an attachment, contains its filename';
$l['threadfields_formhtml_desc_attach_fileext'] = 'If there\'s an attachment, contains its filename extension';
$l['threadfields_formhtml_desc_attach_size'] = 'If there\'s an attachment, contains its filesize';
$l['threadfields_formhtml_desc_attach_size_friendly'] = 'If there\'s an attachment, contains its filesize, formatted';
$l['threadfields_formhtml_desc_attach_mime'] = 'If there\'s an attachment, contains the MIME type sent by the user (caution: this is untrusted input)';
$l['threadfields_formhtml_desc_attach_upload_time'] = 'If there\'s an attachment, contains the time of upload';
$l['threadfields_formhtml_desc_attach_upload_date'] = 'If there\'s an attachment, contains the date of upload';
$l['threadfields_formhtml_desc_attach_update_time'] = 'If there\'s an attachment, contains the time of last update';
$l['threadfields_formhtml_desc_attach_update_date'] = 'If there\'s an attachment, contains the date of last update';
